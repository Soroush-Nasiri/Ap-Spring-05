...
The final project is divided into **2 phases**:
...
|----------|-------------|
| [Basic Commands & VsCode Setup](https://drive.google.com/drive/folders/18-vu__QNIUBXh9otvdbLU0_SARIk0VhQ) | Terminal basics and VS Code environment setup |
| [Git & Github Tutorial](https://drive.google.com/file/d/1BqbtkSohkb2KYz0QKiPSQarRLMTY209Z/view) |  Intro to Git and GitHub |
...
| Name | Role | Email |
|------|------|-------|
| **Soroush Nasiri** | Chief TA | soroush.nasiri@ut.ac.ir |
| **Iliya Afzali** | TA | iliya.afzali@ut.ac.ir |
| **Amir Hosseini** | TA | a.h.teshnizi@ut.ac.ir |
| **Alireza Farrahi** | TA | alireza.farrahi@ut.ac.ir |
| **Mohammad Hossein Nabavi** | TA | s.mh.nabavi@ut.ac.ir |
| **Ali Chegini** | TA | alichegini@ut.ac.ir |

---

<div align="center">
  Made with ❤️ by the AP Spring 1405 TA Team
</div>
